...
const userMenuTransition = {
    leaveActiveClass: 'app-user-menu-leave-active', leaveFromClass: 'app-user-menu-leave-from', leaveToClass: 'app-user-menu-leave-to', onAfterLeave: applyPendingThemeChange
};
...
function toggleTheme() { themeChangePending.value = true; }
...
<template>
    <SidebarMenuItem class="app-sidebar-profile-item">
        <SidebarMenuButton class="app-sidebar-menu-button app-sidebar-header-button" @click="(e) => userMenu.toggle(e)" aria-haspopup="true" aria-controls="user_menu">
