...
<template>
  <div class="profile-page">
    <ProfileHeader :country="country" :badges="badges" :stats="stats" />
    <PerformanceChart />

    <div class="grid-row">
      <Panel title="Skill Profile">
        <SkillProfileTable :rows="skillProfileRows" />
      </Panel>
      <Panel title="Tournament Duel Rating">
        <div class="panel-placeholder" />
      </Panel>
    </div>

    <div class="grid-row">
      <Panel title="Skillset Profile">
        <div class="panel-placeholder" />
      </Panel>
    ...
    <Panel title="Tournament Experience" class="panel-tournament-experience">
...
.panel-tournament-experience { min-height: 390px; }
:global(.experience-placeholders) { display: grid; grid-template-columns: .8fr 1.4fr 1fr; gap: 16px; }
:global(.experience-placeholders .panel-placeholder) { min-height: 250px; }
@media (max-width: 900px) { .grid-row { grid-template-columns: 1fr; } :global(.experience-placeholders) { grid-template-columns: 1fr; } }
</style>
